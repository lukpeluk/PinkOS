...
// convierte música del formato que encontramos (el que tenía el tema de la pantera rosa) al formato de audio que usa PinkOS
...
int main()
{
    ...
    printf("    0,  // Null terminate the song\n");
    printf("};");
    return 0;
}
